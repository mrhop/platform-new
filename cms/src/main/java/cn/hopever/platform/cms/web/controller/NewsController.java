...
public class NewsController implements GenericController<ArticleVo> {
    ...
    public VueResults.Result update(@RequestParam(name = "key") Long key, @RequestParam(name = "screenshots", required = false) MultipartFile[] files, ArticleVo articleVo, Principal principal) {
        return null;
    }
