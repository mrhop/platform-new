...
public class StaticResourceController implements GenericController<StaticResourceVo> {
    ...
    public VueResults.Result update(@RequestParam(name = "key") Long key, @RequestParam(name = "screenshots", required = false) MultipartFile[] files, StaticResourceVo staticResourceVo, Principal principal) {
        return null;
    }
    ...
    public VueResults.Result save(@RequestParam(name = "screenshots", required = false) MultipartFile[] files, StaticResourceVo staticResourceVo, Principal principal) {
        return null;
    }
