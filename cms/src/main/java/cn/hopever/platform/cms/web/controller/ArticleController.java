        ...
        if (keys.get("websiteId") != null) {
            ...
            if (body != null) {
                if ("list".equals(body.get("type"))) {
                    mapReturn.put("articleTags", articleTagTableService.getArticleTagOptions(keys.get("websiteId"), principal));
                } else if ("form".equals(body.get("type"))) {
                    mapReturn.put("articleTags", articleTagTableService.getArticleTagOptions(keys.get("websiteId"), principal));
                    mapReturn.put("templates", templateTableService.getOptionsByWebsiteId(keys.get("websiteId")));
                }
            }
            return mapReturn;
        }
